...
import com.xbug.system.domain.SysTeam;
...
import com.xbug.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
     ...
     * 获取用户列表
     */
    @PreAuthorize("@ss.hasPermi('system:user:list') || @ss.hasPermi('system:team:member:invite') || @ss.hasPermi('system:team:member:create') || @ss.hasPermi('system:project:member')")
    @GetMapping("/list")
